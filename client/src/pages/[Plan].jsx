    ...
    <>
      <div className="flex md:flex-row flex-col animate-in">
        ...
        <div className="basis-2/4">
          <div className="flex items-center flex-col">
            <Link
              to={`/plans/${plan._id}/reserve`}
              className="bg-secondary rounded-2xl text-center text-white text-3xl font-mybold w-[40%] p-2 m-8 hover:w-[41%]"
            >
              Reserve
            </Link>
            ...
            <DayPicker
              className="w-auto bg-white border rounded-md"
              selected={new Date(plan.date)}
              month={plan.date}
              modifiers={{ booked: new Date(plan.date) }}
              modifiersStyles={{
                booked: { border: "2px", backgroundColor: "#34C083" },
              }}
              ISOWeek
              disabled
            />
